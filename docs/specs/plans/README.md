...
Cross-module and long-horizon implementation plans for BitFun.
...
`docs/architecture/`; feature specs and designs stay in the parent directory;
personal task notes remain untracked.

**Authority for status / one-liners:** Chinese index [`../README.md`](../README.md).  
This file is an English convenience list of files under `plans/`.  
Template: [`../templates/plan.md`](../templates/plan.md).

| Plan | Status (see parent index) |
|---|---|
