...
| `observability-otel` | Concrete OpenTelemetry SDK lifecycle, OTLP HTTP exporters, bounded batching, runtime reconfiguration, and pseudonymous installation identity | crate README |
