...
- 完成测试后也可直接更换结果卡形象：既能重新选择 12 个内置猫猫，也能上传新照片；切换不会重新计算猫格，可下载完整的 1600 × 900 PNG，或直接截图保存当前结果。
